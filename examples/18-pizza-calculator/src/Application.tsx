...
// PizzaState is everything in PizzaData plus one more field
...
// initialState is type PizzaState
...
// any time one of these inputs change, recalculate the number of pizzas we need
