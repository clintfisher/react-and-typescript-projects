  ...
  return (
    <main className="Counter">
      ...
      <section className="controls">
        <button onClick={increment} onKeyDown={increment}>Increment</button>
        <button onClick={reset} onKeyDown={reset}>Reset</button>
        <button onClick={decrement} onKeyDown={decrement}>Decrement</button>
      </section>
    </main>
  );
};
